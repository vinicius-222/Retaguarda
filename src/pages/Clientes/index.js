...
const Cliente = (props) => {
    ...
    const [head, setHead] = useState([
        ...
        {'Tipo Cliente':'Tipo Cliente', 'width':'20%'},
    ...
    return(
        <Container>
            <AreaTopo>
                ...
                <ButtonPadrao url="/Clientes/Create" backgroundcolor="#009739" backgroundhover="#026E2B" width={200} height={35} margin="0px 20px" title="CADASTRAR CLIENTES"/>
            </AreaTopo>
            <form>
                <AreaFiltros height={220} align="flex-end">
                    <AreaFiltrosCampos>
                        <p>Cliente/Razão Social</p>
                        <input />
                        <p>Loja(s)</p>
